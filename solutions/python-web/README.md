...
FastAPI backend plus JS frontend. The main standalone pages are [`task2.html`](/home/dmitriyl/olypiad_ar_task/solutions/python-web/frontend/task2.html) for object detection and [`task3.html`](/home/dmitriyl/olypiad_ar_task/solutions/python-web/frontend/task3.html) for light source tracking.
